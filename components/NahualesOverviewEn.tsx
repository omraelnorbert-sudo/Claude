...
export default function NahualesOverviewEn({ items }: { items: NahualOverviewItem[] }) {
              ...
              {open.longText && (
                <div className="nahual-longtext">
                  <div className="eyebrow" style={{ marginBottom: 8 }}>
                    Long version · Omrael Norbert Muigg · Paz Mundo
                  </div>
                  ...
                  {expanded && open.longText.ceremonies.length > 0 && (
                    <div className="nahual-ceremonies">
                      <div className="nahual-ceremonies-label">Ceremonies</div>
                  ...
                  {expanded && (open.longText.bodyLevel || open.longText.powerAnimal) && (
                    <div className="nahual-longtext-footer">
                      {open.longText.bodyLevel && (
                        <div>
                          <div className="nahual-longtext-footer-label">Body level</div>
                          <p className="nahual-longtext-paragraph">{open.longText.bodyLevel}</p>
                        </div>
                      )}
                      {open.longText.powerAnimal && (
                        <div>
                          <div className="nahual-longtext-footer-label">Power animal</div>
